...
func (controller VkController) onHelp(chat_id int) {
	...
	b.WriteString("\nНапример:\n")
	b.WriteString(" + Подписаться на объявления о сдаче комнаты: Снять комнату в Москве около метро Академическая\n")
	b.WriteString(" + Подписаться на объявления о сдаче 1 комнатной квартиры и квартиры студии: Снять однушку, студию в Питере около метро Рыбацкое\n")
